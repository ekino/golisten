...
build: deps golang-crosscompile
	...
	go-darwin-386 build -o release/golisten-darwin-386; \
	go-darwin-amd64 build -o release/golisten-darwin-amd64; \
	go-freebsd-386 build -o release/golisten-freebsd-386; \
...
release:
	...
	github-release upload --user ekino --repo golisten --tag v$(VERSION) --name "golisten-darwin-386" --file release/golisten-darwin-386
	...
	github-release upload --user ekino --repo golisten --tag v$(VERSION) --name "golisten-freebsd-386" --file release/golisten-freebsd-386
